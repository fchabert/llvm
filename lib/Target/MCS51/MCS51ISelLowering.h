...
#ifndef LLVM_TARGET_MCS51_ISELLOWERING_H
#define LLVM_TARGET_MCS51_ISELLOWERING_H
...
namespace llvm {
  ...
  public:
    explicit MCS51TargetLowering(MCS51TargetMachine &TM);
    ...
    /// Ty1 to type Ty2. e.g. On MCS51 it's free to truncate a i16 value in
    ...
    /// necessarily apply to truncate instructions. e.g. on MCS51, all
...
#endif // LLVM_TARGET_MCS51_ISELLOWERING_H
