...
#ifndef LLVM_TARGET_MCS51_SUBTARGET_H
#define LLVM_TARGET_MCS51_SUBTARGET_H
...
public:
  ...
  ///
  MCS51Subtarget(const std::string &TT, const std::string &CPU,
                  const std::string &FS);
...
#endif  // LLVM_TARGET_MCS51_SUBTARGET_H
